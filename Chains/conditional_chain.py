...
class Feedback(BaseModel):
    sentiment: Literal["positive", "negative"] = Field(description="Sentiment of user feedback")
...
branch_chain = RunnableBranch(
    ...
    RunnableLambda(lambda _: "Could not detect sentiment")
)

chain = classifier_chain | branch_chain

result = chain.invoke({'feedback': 'This is a awesome earphone'})
print(result)
